...
<head>
    ...
    <title>lazywriter</title>
    <meta name="author" content="rhnfirdaus21">
...
<header class="w-full container mx-auto">
    <div class="flex flex-col items-center py-12">
        <a class="font-bold text-gray-800 lowercase hover:text-gray-700 text-5xl" href="{{route('home')}}">
            lazywriter
        </a>
...
<!-- Topic Nav -->
<nav class="w-full py-4 border-t border-b bg-gray-100 items-center justify-items-center" x-data="{ open: false }">
    ...
    <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
        <div
            class="w-full container mx-auto flex flex-col sm:flex-row items-center justify-between justify-items-center text-sm font-bold uppercase mt-0 px-6 py-2">
...
<footer class="w-full border-t bg-white pb-12">
    <div class="w-full container mx-auto flex flex-col items-center">
        <div class="uppercase py-6">&copy; lazywriter</div>
    </div>
</footer>
